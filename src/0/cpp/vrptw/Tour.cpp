/*
 * VRPTW Tour Implementation
 * 
 * Implementation of tour operations for the Vehicle Routing Problem with Time Windows.
 */

#include "Tour.h"

// Update tour cost and demand based on instance data (considers time windows)
void Tour::updateCostAndDemand(const Instance& instance) {
    ...
    if (nodes.size() > 0) {
        ...
        // Cost between consecutive customers in the tour
