/*
 * CVRP Tour Implementation
 * 
 * Implementation of tour operations for the Capacitated Vehicle Routing Problem.
 */

#include "Tour.h"

// Update tour cost and demand based on instance data
