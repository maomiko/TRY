 ...
 * CVRP Tour Header
 * 
 * Defines the Tour structure for the Capacitated Vehicle Routing Problem.
...
/*
 * Tour structure representing a vehicle route
 * A tour is a sequence of customer nodes that starts and ends at the depot (node 0).
 * Each tour has an associated total demand and cost.
 */
struct Tour {
