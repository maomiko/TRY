...
{
    GainType Cost, Gain, G0, LKRouteScore = 0, LKRouteCost = 0;
    int X2, i, it = 0, LKRouteNodes = 0;
    Node *t1, *t2, *SUCt1;
    Candidate *Nt1;
    Segment *S;
    SSegment *SS;
    ...
    LKRouteNodes = RouteNodes;
    LKRouteScore = RouteScore;
    LKRouteCost = RouteCost;
    if (TraceLevel >= 3 ||
        (TraceLevel == 2 &&
  ...
  End_LinKernighan:
    ...
    Reversed = 0;
    RouteNodes = LKRouteNodes;
    RouteScore = LKRouteScore;
    RouteCost = LKRouteCost;
    return Cost;
}
