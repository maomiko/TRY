...
GainType MergeWithTourCLARIST(void)
{
    ...
    int RouteNodes1 = 0;
    GainType RouteScore1 = 0;
    GainType RouteCost1 = 0;
    ...
    if (Penalty) {
        ...
        Penalty1 = Penalty();
        RouteNodes1 = RouteNodes;
        RouteScore1 = RouteScore;
    ...
    if (Cost1 == Cost2) {
        ...
        if (N == FirstNode &&
            ...
            RouteNodes = RouteNodes1;
            RouteScore = RouteScore1;
            RouteCost = RouteCost1;
            return Cost1;
        }
    }
    OldCost1 = Cost1;
